...
public class GuiIngameMenu extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        if( !mc.isIntegratedServerRunning() ) // (If connected to real server)
        {
            ...
            ((GuiButton)this.buttonList.get(0)).yPosition = height / 4 + 144 + var1;
            ((GuiButton)this.buttonList.get(2)).yPosition = height / 4 + 120 + var1;
            ((GuiButton)this.buttonList.get(3)).yPosition = height / 4 + 120 + var1;
        }
        /*<<<WDL*/
